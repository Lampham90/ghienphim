      ...
      <div className="max-w-[1920px] mx-auto px-6 md:px-20">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/">
              <h2 className="text-2xl font-black italic tracking-tighter text-white mb-6">
                GHIỀN<span className="text-red-600">PHIM</span>
              </h2>
            </Link>
            <p className="text-white/40 text-sm leading-relaxed italic">
              2026 Ghiền Phim Project. <br />
              Project học tập code , không kinh doanh mua bán, quảng cáo dưới mọi hình thức.
            </p>
          </div>
        ...
        <div className="border-t border-white/5 pt-8 text-center">
          <p className="text-white/20 text-[10px] uppercase tracking-[0.3em] font-bold">
            © {new Date().getFullYear()} Ghiền Phim. 
          </p>
        </div>
      </div>
    </footer>
