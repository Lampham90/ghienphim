...
export async function GET(req: Request) {
  ...
  try {
    ...
    // Backdrop & Poster: TMDB hầu như không có bản tiếng Việt cho 2 loại ảnh này,
    // nên lấy ảnh xếp hạng cao nhất mặc định (TMDB đã tự sort theo vote_average/vote_count giảm dần)
